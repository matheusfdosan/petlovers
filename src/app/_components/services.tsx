...
export function Services() {
  const [emblaRef, emblaApi] = useEmblaCarousel({
    loop: true,
    align: "start",
    slidesToScroll: 1, // quantidade de cards que aparecerão no slider
    breakpoints: {
      "(min-width: 768px)": { slidesToScroll: 3 }, // quando a tela aumentar, a quantidade de cards que aparecerão no slider também aumentarão
    },
  })
  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="font-4xl text-4xl font-bold mb-12">Nossos serviços</h2>

        <div className="relative" data-aos="fade-rigth">
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {services.map((item, index) => (
                <div
                  key={index}
                  className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3 select-none"
                >
